      ...
      <View style={styles.filterContainer}>
        ...
        <View style={styles.cameraUIView}>
          <TouchableOpacity style={styles.menuButton} onPress={switchCameraDirection}>
            <Text style={_styles.NsrfEjOX}>{switchCamera ? <Icon name="camera-rear-variant" size={25} color="#fff" /> : <Icon name="camera-front-variant" size={25} color="#fff" />}</Text>
          </TouchableOpacity>
          <TouchableOpacity style={styles.menuButton} onPress={handleTakePicture}>
            <Text style={_styles.GFQTLtmq}><Icon name="camera-iris" size={50} color="#fff" /></Text>
          </TouchableOpacity>
          <TouchableOpacity style={styles.menuButton} onPress={switchFlashLight}>
            <Text style={_styles.GZMzjjoO}>{switchFlash ? <Icon name="flash" size={25} color="#fff" /> : <Icon name="flash-off" size={25} color="#fff" />}</Text>
          </TouchableOpacity>
        </View>
