...
## Project Structure
    ...
    ├── studioscreen_dev_50843  # Django project configurations
...
1. Clone this repo and `cd studioscreen_dev_50843`
...
2. Clone this repo and `cd studioscreen_dev_50843`
